...
const AutoSwiper = () => {
  const items = [
    { text: "BEST OF BEHANCE", subtext:'16', imgUrl: "/assets/Vector (7).png" },
    { text: "UI/UX",  subtext:'2',imgUrl: "/assets/aaa.png" },
    { text: "HONORABLE MENTIONS",  subtext:'3', imgUrl: "/assets/Vector (7).png" },
    { text: "SITE OF THE DAY",   subtext:'16',imgUrl: "/assets/aaa.png" },
    { text: "MOBILE EXCELLENCE",  subtext:'2', imgUrl: "/assets/Vector (7).png" },
    { text: "BEST OF BEHANCE",  subtext:'3', imgUrl: "/assets/aaa.png" },
    { text: "DEDICATED",  subtext:'16', imgUrl: "/assets/Vector (7).png" },
    { text: "BEST OF BEHANCE",  subtext:'3', imgUrl: "/assets/aaa.png" },
  ];
